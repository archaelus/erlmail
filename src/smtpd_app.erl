...
%%% Purpose     : SMTD applicaiton definition file
%%% Created     : 2007-10-18
%%% Initial Rel : 0.0.5
%%% Updated     : 2007-10-18
%%%----------------------------------------------------------------------
...
%%----------------------------------------------------------------------
start(_Type, _Args) ->
    ListenPort = get_app_env(listen_port, ?SMTPD_PORT),
    ...
    {ok,
        {_SupFlags = {one_for_one, ?MAX_RESTART, ?MAX_TIME},
            [
              ...
              {   smtpd_client_sup,
                  {supervisor,start_link,[{local, smtpd_sup}, ?MODULE, [Module]]},
                  permanent,                               % Restart  = permanent | transient | temporary
